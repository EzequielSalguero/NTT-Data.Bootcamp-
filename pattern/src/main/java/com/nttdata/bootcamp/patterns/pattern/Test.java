...
import com.nttdata.bootcamp.patterns.decorator.PersonDecorator;
import com.nttdata.bootcamp.patterns.proxy.PersonProxy;
...
public class Test implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		//USO DE PROTOTYPE
		System.out.println("-----MUESTRA DE DATOS DE OBJETOS CREADOS Y CLONADOS CON PATRON PROTOTYPE-----");
		...
		System.out.println("-----MUESTRA DE DATOS DE OBJETOS CREADOS HACIENDO USO DEL PATRO BUILDER-----");
  		...
  		System.out.println("-----MUESTRA DE DATOS DE OBJETOS CREADOS HACIENDO USO DEL PATRON BUILDER-----");
  		...
  		System.out.println("-----MUESTRA DE USO DEL PATRON CHANGE OF RESPONSABILITY-----");
